...
openai.api_key = os.environ.get("OPENAI_KEY", None) or open('/Users/felixgonzalez/.openai_key').read().strip()
...
class ElevenLabsTTS:
    ...
    def __init__(self, voice_id=None):
        api_key_fpath='/Users/felixgonzalez/.elevenlabs_apikey'
...
"""
pd = PodcastXMLHandler.from_xml('/Users/felixgonzalez/Downloads/podcast.xml')
...
pd.to_xml('/Users/felixgonzalez/Downloads/podcast2.xml')
"""
pass
...
class PodcastRSSFeed:
    ...
    def upload_episode(self, file_path, file_name, episode_title, episode_description):
        ...
        token = os.environ.get("GH_KEY", None) or open("/Users/felixgonzalez/.gh_token").read().strip()
        gh = Github(token)
